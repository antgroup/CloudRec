...
CloudRec Lite is the lightweight local edition for small and mid-sized teams:
one CLI binary, local SQLite storage, an embedded read-only Web dashboard, and
Alibaba Cloud rule quality gates that can run offline.
...
See [lite/README.md](lite/README.md) for the full Lite user guide and
